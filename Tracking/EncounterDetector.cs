...
namespace Foot_Tracker.Tracking
{
    ...
    Bitmap source)
     ...
     out string pokemonName)
        ...
        {
            // Title bar height scales with PRO's GUI.
            //
            // ~9% of total battle height gives us enough room
            // at both small and large GUI scales.
            int titleHeight =
                (int)Math.Round(
                    battleBounds.Height * 0.09
                );

            // Keep sensible limits for unusual window sizes.
            titleHeight =
                Math.Clamp(
                    titleHeight,
                    45,
