...
internal static class ImageOps
{
    ...
    public static SKBitmap Crop(SKBitmap source, SKRectI region)
    {
        ...
        // churned between SkiaSharp versions, e.g. SKPaint.FilterQuality below).
    ...
    /// <summary>Converts every pixel to pure black/white based on a brightness threshold, in place.</summary>
