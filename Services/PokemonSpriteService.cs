...
namespace Foot_Tracker.Services
{
    ...
    PokemonFormEntry form)
        ...
        public static Image? GetSprite(string pokemonName)
        {
        ...
        public static Image? GetEncounterSprite(string pokemonName)
        {
            if (string.IsNullOrWhiteSpace(pokemonName))
                return null;
        ...
        private static Image? LoadSprite(string spriteFile)
        {
        ...
        public static string ResolveEncounterName(string detectedName)
        {
